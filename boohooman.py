...
BASE_URL = "https://www.boohooman.com/categories/mens-clothing"
MAX_PAGES = 120

ATTRIBUTE_LABELS = [
    "Colour:", "Color:", "Style:", "Size:", "Fit:",
    "Length:", "Sleeve Length:", "Occasion:", "Fabric:"
]
...
def extract_page(page, page_number, today):
    ...
    print(f"\nLoading BoohooMAN page {page_number}: {url}")
...
def main():
    ...
    with sync_playwright() as p:
        ...
        for page_number in range(1, MAX_PAGES + 1):
            ...
            if not products:
                print(
                    f"No BoohooMAN products on page "
    ...
    if df.empty:
        print("NO BOOHOOMAN PRODUCTS CAPTURED")
        return
    ...
    if os.path.exists("boohooman_history.csv"):
        old = pd.read_csv("boohooman_history.csv")
    ...
    if os.path.exists("boohooman_summary.csv"):
    ...
    print(
        f"\nTOTAL UNIQUE BOOHOOMAN PRODUCTS: {len(df)}"
    )
